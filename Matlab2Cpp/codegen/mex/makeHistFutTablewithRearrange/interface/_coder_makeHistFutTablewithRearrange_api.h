 ...
 *
 * _coder_makeHistFutTablewithRearrange_api.h
 *
...
extern void makeHistFutTablewithRearrange_api(const mxArray * const prhs[4],
  const mxArray *plhs[1]);

#endif

/* End of code generation (_coder_makeHistFutTablewithRearrange_api.h) */
