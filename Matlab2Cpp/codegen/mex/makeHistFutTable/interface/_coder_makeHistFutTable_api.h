...
extern void makeHistFutTable_api(const mxArray * const prhs[3], const mxArray
  *plhs[1]);

#endif

/* End of code generation (_coder_makeHistFutTable_api.h) */
