...
static emlrtDCInfo g_emlrtDCI = { 4, 15, "compmat",
  "C:\\Users\\Spencer\\Documents\\MATLAB\\CurverCPPprep\\compmat.m", 1 };

static emlrtDCInfo h_emlrtDCI = { 4, 15, "compmat",
  "C:\\Users\\Spencer\\Documents\\MATLAB\\CurverCPPprep\\compmat.m", 4 };

static emlrtBCInfo s_emlrtBCI = { -1, -1, 7, 5, "py", "compmat",
             ...
             emxArray_real_T *y)
{
  ...
  y->size[0] = 1;
  if (!(dims >= 0.0)) {
    emlrtNonNegativeCheckR2012b(dims, (emlrtDCInfo *)&h_emlrtDCI, sp);
  }

  d3 = dims;
  if (d3 != (int32_T)muDoubleScalarFloor(d3)) {
    emlrtIntegerCheckR2012b(d3, (emlrtDCInfo *)&g_emlrtDCI, sp);
  }
  ...
  while (i <= (int32_T)dims - 1) {
    ...
    i1 = y->size[1];
    if (!((i + 1 >= 1) && (i + 1 <= i1))) {
      emlrtDynamicBoundsCheckR2012b(i + 1, 1, i1, (emlrtBCInfo *)&s_emlrtBCI, sp);
    }
