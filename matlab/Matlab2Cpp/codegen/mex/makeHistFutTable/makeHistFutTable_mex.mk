...
MAKEFILE = makeHistFutTable_mex.mk

include makeHistFutTable_mex.mki


SRC_FILES =  \
	makeHistFutTable_data.cpp \
	...
	makeHistFutTable_emxutil.cpp

MEX_FILE_NAME_WO_EXT = makeHistFutTable_mex
...
SYS_INCLUDE += -I "$(START_DIR)\codegen\mex\makeHistFutTable"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\makeHistFutTable/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\makeHistFutTable/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\makeHistFutTable/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
