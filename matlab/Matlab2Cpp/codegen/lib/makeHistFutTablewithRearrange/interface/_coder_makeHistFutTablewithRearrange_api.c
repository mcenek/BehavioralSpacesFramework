 ...
 * File: _coder_makeHistFutTablewithRearrange_api.c
 *
...
emlrtContext emlrtContextGlobal = { true, false, 131434U, NULL,
  "makeHistFutTablewithRearrange", NULL, false, { 2045744189U, 2170104910U,
 ...
 * Return Type  : void
 */
void makeHistFutTablewithRearrange_api(const mxArray *prhs[4], const mxArray
  *plhs[1])
{
  ...
  e_emlrt_marshallIn(&st, emlrtAlias(prhs[3]), "rmat", rmat);
 ...
 * Return Type  : void
 */
void makeHistFutTablewithRearrange_atexit(void)
{
  emlrtStack st = { NULL, NULL, NULL };
  ...
  makeHistFutTablewithRearrange_xil_terminate();
}
 ...
 * Return Type  : void
 */
void makeHistFutTablewithRearrange_initialize(void)
{
  emlrtStack st = { NULL, NULL, NULL };
 ...
 * Return Type  : void
 */
void makeHistFutTablewithRearrange_terminate(void)
{
  emlrtStack st = { NULL, NULL, NULL };
...
/*
 * File trailer for _coder_makeHistFutTablewithRearrange_api.c
 *
 * [EOF]
 */
