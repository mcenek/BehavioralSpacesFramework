...
// File: makeHistFutTablewithRearrange.cpp
//
...
//                double range
//                double dims
//                const emxArray_real_T *rmat
//                emxArray_real_T *y
// Return Type  : void
//
void makeHistFutTablewithRearrange(const emxArray_uint8_T *testm, double range,
  double dims, const emxArray_real_T *rmat, emxArray_real_T *y)
{
  emxArray_real_T *res;
  int ii;
  int idx;
  ...
  while (its <= (int)d0 - 1) {
    ...
    if (k == 0) {
      ...
      if (k == 0) {
        ...
        if (rmat->data[(int)xcor - 1] != -1.0) {
          xcor = rmat->data[(int)xcor - 1];
        }

        if (rmat->data[(int)ycor - 1] != -1.0) {
          ycor = rmat->data[(int)ycor - 1];
        }
...
//
// File trailer for makeHistFutTablewithRearrange.cpp
//
// [EOF]
//
